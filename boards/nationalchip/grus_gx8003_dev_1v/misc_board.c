...
# ifdef CONFIG_BOARD_PDM_SLAVE
    ret += _BoardPadmuxSet(1, 7);
# else
...
# ifndef CONFIG_BOARD_HAS_UART0_JUST_SUPPORT_PRINTF_LOG
...
#if defined(CONFIG_BOARD_HAS_DAC_OUT)
    ret += _BoardPadmuxSet(7, 7);
    ret += _BoardPadmuxSet(8, 7);
#endif
...
// #endif
    ...
    ret += _BoardPadmuxSet(0, 5);
    ret += _BoardPadmuxSet(1, 5);
    ret += _BoardPadmuxSet(11, 5);
    ret += _BoardPadmuxSet(12, 5);
#endif
...
// #if defined(CONFIG_BOARD_HAS_AIN_I2S_OUT_MASTER)
//     ret += _BoardPadmuxSet(7, 6);
//     ret += _BoardPadmuxSet(8, 6);
//     ret += _BoardPadmuxSet(9, 6);
//     ret += _BoardPadmuxSet(10, 6);
// #endif

// #if defined(CONFIG_BOARD_HAS_AIN_I2S_OUT_SLAVE)
//     ret += _BoardPadmuxSet(7, 9);
//     ret += _BoardPadmuxSet(8, 9);
//     ret += _BoardPadmuxSet(9, 9);
//     ret += _BoardPadmuxSet(10, 6);
// #endif
...
// #if defined(CONFIG_BOARD_HAS_AOUT_I2S_M)
//     ret += _BoardPadmuxSet(7, 3);
//     ret += _BoardPadmuxSet(8, 3);
//     ret += _BoardPadmuxSet(9, 3);
//     ret += _BoardPadmuxSet(10, 3);
// #endif

// #if defined(CONFIG_BOARD_HAS_AOUT_I2S_S)
//     ret += _BoardPadmuxSet(7, 8);
//     ret += _BoardPadmuxSet(8, 8);
//     ret += _BoardPadmuxSet(9, 8);
//     ret += _BoardPadmuxSet(10, 3);
// #endif
...
#if defined CONFIG_USE_MP3 || defined CONFIG_USE_OPUS || defined CONFIG_USE_ADPCM
    padmux_set(CONFIG_LVP_VOICE_PLAYER_MUTE_PIN, CONFIG_LVP_VOICE_PLAYER_MUTE_PIN == 2 ? 0 : 1);
    gx_gpio_set_direction(CONFIG_LVP_VOICE_PLAYER_MUTE_PIN, GX_GPIO_DIRECTION_OUTPUT);
