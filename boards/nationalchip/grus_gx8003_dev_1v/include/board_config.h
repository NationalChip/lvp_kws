...
#define CONFIG_BOARD_PATH           boards/nationalchip/grus_gx8003_dev_1v
...
#if defined CONFIG_MCU_FREQUENCY_1M
# define CUSTOMIZE_FREQUENCY_MCU_DIV_PARAM (24 * _PLL_MULTIPLE)
#elif defined CONFIG_MCU_FREQUENCY_2M
# define CUSTOMIZE_FREQUENCY_MCU_DIV_PARAM (12 * _PLL_MULTIPLE)
#elif defined CONFIG_MCU_FREQUENCY_4M
# define CUSTOMIZE_FREQUENCY_MCU_DIV_PARAM (6 * _PLL_MULTIPLE)
#elif defined CONFIG_MCU_FREQUENCY_8M
