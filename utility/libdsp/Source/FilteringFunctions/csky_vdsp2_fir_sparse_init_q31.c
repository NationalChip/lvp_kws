...
*
* This file comes from arm_fir_sparse_init_q31.c. It is renamed by replacing arm
* with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_fir_sparse_init_q31.c
 * @brief    Q31 sparse FIR filter initialization function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 * <code>blockSize</code> is the number of words processed by <code>csky_vdsp2_fir_sparse_q31()</code> function.
 */
