...
* Description:  Initialization function for floating-point transposed Direct Form II Biquad cascade filter. 2 channels
*
...
*
* This file comes from arm_biquad_cascade_stereo_df2T_init_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_biquad_cascade_stereo_df2T_init_f32.c
