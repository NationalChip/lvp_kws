...
*
* This file comes from arm_conv_q7.c. It is renamed by replacing arm with csky.
*
*/
 ...
 *
 * \par
 * Refer the function <code>csky_conv_opt_q7()</code> for a faster implementation of this function.
 *
 */
