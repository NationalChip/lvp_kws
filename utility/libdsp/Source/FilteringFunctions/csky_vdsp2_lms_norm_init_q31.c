...
*
* This file comes from arm_lms_norm_init_q31.c. It is renamed by replacing arm with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_lms_norm_init_q31.c
 * @brief    Q31 NLMS initialization function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>csky_vdsp2_lms_norm_q31()</code>.
 */
  ...
  uint8_t postShift)
{
  ...
  S->recipTable = (q31_t *) cskyRecipTableQ31;
