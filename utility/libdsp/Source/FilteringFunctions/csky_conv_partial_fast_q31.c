...
* Title:        arm_conv_partial_fast_opt_q31.c
...
*
* This file comes from arm_conv_partial_fast_q31.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_conv_partial_fast_q31.c
 * @brief    Fast Q31 Partial convolution.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 *
 * \par
 * See <code>csky_conv_partial_q31()</code> for a slower implementation of this function which uses a 64-bit accumulator to provide higher precision.
 */
