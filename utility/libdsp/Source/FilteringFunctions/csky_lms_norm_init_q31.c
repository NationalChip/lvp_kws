...
*
* This file comes from arm_lms_norm_init_q31.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_lms_norm_init_q31.c
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>csky_lms_norm_q31()</code>.
 */
