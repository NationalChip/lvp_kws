...
*
* This file comes from arm_conv_partial_q7.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_conv_partial_q7.c
 ...
 *
 * \par
 * Refer the function <code>csky_conv_partial_opt_q7()</code> for a faster implementation of this function.
 *
 */
  ...
  else
  {
    ...
    {/*{{{*/
      ...
      while(blkCnt > 0u)
      {
        ...
        /* Store the result in the accumulator in the destination buffer. */
        *pOut++ = (q7_t) (__SSAT_8(acc0 >> 7));
        *pOut++ = (q7_t) (__SSAT_8(acc1 >> 7));
        *pOut++ = (q7_t) (__SSAT_8(acc2 >> 7));
        *pOut++ = (q7_t) (__SSAT_8(acc3 >> 7));
