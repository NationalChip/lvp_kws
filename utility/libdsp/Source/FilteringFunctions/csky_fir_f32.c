...
* Title:        arm_fir_f32.c
* Description:  Floating-point FIR processing function
*
...
*
* This file comes from arm_fir_f32.c. It is renamed by replacing arm with csky.
*
*/
...
uint32_t blockSize)
{
   ...
   uint32_t numTaps = S->numTaps;                 /* Number of filter coefficients in the filter */
   uint32_t i, tapCnt, blkCnt;                    /* Loop counters */
   float32_t p0,p1,p2,p3;             /* Temporary product values */
