...
* Title:        arm_lms_f32.c
* Description:  Processing function for the floating-points LMS filter
*
...
*
* This file comes from arm_lms_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_lms_f32.c
 * @brief    Processing function for the floating-point LMS filter..
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 * The CSI DSP Library contains LMS filter functions that operate on Q15, Q31, and floating-point data types.
