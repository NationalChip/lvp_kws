...
*
* This file comes from arm_biquad_cascade_df1_fast_q31.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_biquad_cascade_df1_fast_q31.c
 ...
 * csky_biquad_cascade_df1_init_q31() to initialize filter structure.
 *
 * \par
 * Refer to the function <code>csky_biquad_cascade_df1_q31()</code> for a slower implementation of this function which uses 64-bit accumulation to provide higher precision.  Both the slow and the fast versions use the same instance structure.
 * Use the function <code>csky_biquad_cascade_df1_init_q31()</code> to initialize the filter structure.
 */
