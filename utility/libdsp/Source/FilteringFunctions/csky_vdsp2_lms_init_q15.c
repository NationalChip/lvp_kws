...
*
* This file comes from arm_lms_init_q15.c. It is renamed by replacing arm with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_lms_init_q15.c
 * @brief    Q15 LMS filter initialization function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
...
* input samples processed by each call to <code>csky_vdsp2_lms_q15()</code>.
*/
