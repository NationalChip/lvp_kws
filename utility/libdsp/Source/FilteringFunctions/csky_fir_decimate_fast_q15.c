...
*
* This file comes from arm_fir_decimate_fast_q15.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_decimate_fast_q15.c
 * @brief    Fast Q15 FIR Decimator.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 *
 * \par
 * Refer to the function <code>csky_fir_decimate_q15()</code> for a slower implementation of this function which uses 64-bit accumulation to avoid wrap around distortion.
 * Both the slow and the fast versions use the same instance structure.
 * Use the function <code>csky_fir_decimate_init_q15()</code> to initialize the filter structure.
 */
