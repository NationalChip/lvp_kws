...
*
* This file comes from arm_fir_decimate_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_decimate_f32.c
 * @brief    FIR decimation for floating-point sequences.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 *
 * The FIR decimator functions provided in the CSI DSP Library combine the FIR filter and the decimator in an efficient manner.
