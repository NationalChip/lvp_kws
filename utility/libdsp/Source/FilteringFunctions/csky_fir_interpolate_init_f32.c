...
*
* This file comes from arm__fir_interpolate_init_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_interpolate_init_f32.c
 * @brief    Floating-point FIR interpolator initialization function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>csky_fir_interpolate_f32()</code>.
 */
