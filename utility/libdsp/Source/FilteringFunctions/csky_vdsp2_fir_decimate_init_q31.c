...
*
* This file comes from arm_fir_decimate_init_q31.c. It is renamed by replacing
* arm with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_fir_decimate_init_q31.c
 ...
 * <code>pState</code> is of length <code>numTaps+blockSize-1</code> words where <code>blockSize</code> is the number of input samples passed to <code>csky_vdsp2_fir_decimate_q31()</code>.
