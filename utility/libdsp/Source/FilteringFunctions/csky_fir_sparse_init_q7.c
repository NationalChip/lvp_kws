...
*
* This file comes from arm_fir_sparse_init_q7.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_sparse_init_q7.c
 ...
 * number of samples processed by the <code>csky_fir_sparse_q7()</code> function.
 */
