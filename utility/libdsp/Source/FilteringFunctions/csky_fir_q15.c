...
*
* This file comes from arm_fir_q15.c. It is renamed by replacing arm with csky.
*
*/
 ...
 *
 * \par
 * Refer to the function <code>csky_fir_fast_q15()</code> for a faster but less precise implementation of this function.
 */
