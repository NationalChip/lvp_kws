...
*
* This file comes from arm_fir_interpolate_init_q31.c. It is renamed by replacing arm with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_fir_interpolate_init_q31.c
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>csky_vdsp2_fir_interpolate_q31()</code>.
 */
