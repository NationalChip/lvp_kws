...
*
* This file comes from arm_fir_sparse_init_q15.c. It is renamed by replacing arm
* with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_fir_sparse_init_q15.c
 * @brief    Q15 sparse FIR filter initialization function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 * number of words processed by <code>csky_vdsp2_fir_sparse_q15()</code> function.
 */
