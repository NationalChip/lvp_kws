...
*
* This file comes from arm_iir_lattice_q15.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_iir_lattice_q15.c
    ...
    *px2++ = (q15_t) gnext;
    ...
    while(tapCnt > 0u)
    {
      ...
      *px2++ = (q15_t) gnext1;
      ...
      fcurr = __SSAT_16(fcurr);
      /* gN-2(n) = kN-2 * fN-3(n) + gN-3(n-1) */
      gnext = (((q31_t) fcurr * (*pk++)) >> 15) + gcurr;
      gnext2 = (q15_t) __SSAT_16(gnext);
