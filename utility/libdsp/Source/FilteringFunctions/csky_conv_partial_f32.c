...
*
* This file comes from arm_conv_partial_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_conv_partial_f32.c
 ...
 * If the requested subset does not fall in this range then the functions return CSKY_MATH_ARGUMENT_ERROR.
 * Otherwise the functions return CSKY_MATH_SUCCESS.
 * \note Refer csky_conv_f32() for details on fixed point behavior.
 *
 *
 * <b>Fast Versions</b>
 *
