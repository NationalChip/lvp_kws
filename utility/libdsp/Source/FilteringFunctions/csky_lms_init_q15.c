...
*
* This file comes from arm_lms_init_q15.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_lms_init_q15.c
...
* input samples processed by each call to <code>csky_lms_q15()</code>.
*/
