...
* Description:  High preision Q31 Biquad cascade filter processing function.
*
...
*
* This file comes from arm_biquad_cascade_df1_32x64_q31.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_biquad_cascade_df1_32x64_q31.c
 * @brief    High precision Q31 Biquad cascade filter processing function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 *     y[n] = b0 * x[n] + b1 * x[n-1] + b2 * x[n-2] - a1 * y[n-1] - a2 * y[n-2]
 * </pre>
 * In this case the feedback coefficients <code>a1</code> and <code>a2</code> must be negated when used with the CSI DSP Library.
 *
 * \par
 ...
 *
 * \par
 * Two related functions are provided in the CSI DSP library.
 * <code>csky_biquad_cascade_df1_q31()</code> implements a Biquad cascade with 32-bit coefficients and state variables with a Q63 accumulator.
 * <code>csky_biquad_cascade_df1_fast_q31()</code> implements a Biquad cascade with 32-bit coefficients and state variables with a Q31 accumulator.
 */
