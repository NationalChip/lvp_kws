...
* Description:  Processing function for the floating-point transposed Direct Form II Biquad cascade filter
*
...
*
* This file comes from arm_biquad_cascade_df2T_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_biquad_cascade_df2T_f32.c
...
*
* \par
* The CSI library contains Biquad filters in both Direct Form I and transposed Direct Form II.
* The advantage of the Direct Form I structure is that it is numerically more robust for fixed-point data types.
* That is why the Direct Form I structure supports Q15 and Q31 data types.
* The transposed Direct Form II structure, on the other hand, requires a wide dynamic range for the state variables <code>d1</code> and <code>d2</code>.
* Because of this, the CSI library only has a floating-point version of the Direct Form II Biquad.
...
#elif defined(CSKY_MATH_NO_SIMD)
