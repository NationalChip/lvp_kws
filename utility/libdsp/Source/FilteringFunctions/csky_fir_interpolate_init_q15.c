...
* Description:  Q15 FIR filter interpolator initialization function
*
...
*
* This file comes from arm_fir_interpolate_init_q15.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_interpolate_init_q15.c
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>csky_fir_interpolate_q15()</code>.
 */
