...
* Description:  Q31 FIR filter interpolator initialization function
*
...
*
* This file comes from arm_fir_interpolate_init_q31.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_interpolate_init_q31.c
 * @brief    Q31 FIR interpolator initialization function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>csky_fir_interpolate_q31()</code>.
 */
