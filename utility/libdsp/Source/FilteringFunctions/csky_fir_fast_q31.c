...
* Description:  Processing function for the Q31 FIR filter
*
...
*
* This file comes from arm_fir_fast_q31.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_fast_q31.c
 ...
 *
 * \par
 * Refer to the function <code>csky_fir_q31()</code> for a slower implementation of this function which uses a 64-bit accumulator to provide higher precision.  Both the slow and the fast versions use the same instance structure.
 * Use the function <code>csky_fir_init_q31()</code> to initialize the filter structure.
 */
