...
* Description:  Processing function for floating-point Lattice filter
*
...
*
* This file comes from arm_fir_lattice_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_lattice_f32.c
