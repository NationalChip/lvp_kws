...
/******************************************************************************
 * @file     csky_biquad_cascade_df1_fast_q15.c
 ...
 *
 * \par
 * Refer to the function <code>csky_biquad_cascade_df1_q15()</code> for a slower implementation of this function which uses 64-bit accumulation to avoid wrap around distortion.  Both the slow and the fast versions use the same instance structure.
 * Use the function <code>csky_biquad_cascade_df1_init_q15()</code> to initialize the filter structure.
 *
 */
