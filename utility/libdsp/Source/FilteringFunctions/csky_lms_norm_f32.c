...
* Description:  Processing function for the floating-points NLMS filter
*
...
*
* This file comes from arm_lms_norm_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_lms_norm_f32.c
 * @brief    Processing function for the floating-point Normalised LMS.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 * The CSI DSP Library contains normalized LMS filter functions that operate on Q15, Q31, and floating-point data types.
 *
