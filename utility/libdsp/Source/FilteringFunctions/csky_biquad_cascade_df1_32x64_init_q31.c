...
* Description:  High preision Q31 Biquad cascade filter inittialization function.
*
...
*
* This file comes from arm_biquad_cascade_df1_32x64_init_q31.c. It is renamed by
* replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_biquad_cascade_df1_32x64_init_q31.c
 * @brief    High precision Q31 Biquad cascade filter initialization function.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
