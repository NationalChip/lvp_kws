...
*
* This file comes from arm_fir_q7.c. It is renamed by replacing arm with csky.
*
*/
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *pStateCurnt++ = *pSrc++;
    ...
    acc0 = __SSAT_8((acc0 >> 7u));
    *pDst++ = acc0;
    acc1 = __SSAT_8((acc1 >> 7u));
    *pDst++ = acc1;
    acc2 = __SSAT_8((acc2 >> 7u));
    *pDst++ = acc2;
    acc3 = __SSAT_8((acc3 >> 7u));
    *pDst++ = acc3;
