...
* Description:  Floating-point FIR interpolation function
*
...
*
* This file comes from arm_fir_interpolate_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_fir_interpolate_f32.c
 * @brief    FIR interpolation for floating-point sequences.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
 ...
 *
 * The FIR interpolator functions provided in the CSI DSP Library combine the upsampler and FIR filter in an efficient manner.
