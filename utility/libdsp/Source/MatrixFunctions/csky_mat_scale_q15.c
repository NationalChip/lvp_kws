...
*
* This file comes from arm_mat_scale_q15.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_mat_scale_q15.c
  ...
  csky_matrix_instance_q15 * pDst)
{
...
#endif //    #ifdef CSKY_MATH_MATRIX_CHECK
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      in1 = (q15_t) (__SSAT_16(out1));
      in2 = (q15_t) (__SSAT_16(out2));
      in3 = (q15_t) (__SSAT_16(out3));
      in4 = (q15_t) (__SSAT_16(out4));
    ...
    while(blkCnt > 0u)
    {
      ...
      /* Scale, saturate and then store the results in the destination buffer. */
      *pOut++ =
        (q15_t) (__SSAT_16(((q31_t) (*pIn++) * scaleFract) >> totShift));
