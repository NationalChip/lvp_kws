...
*
* This file comes from arm_mat_inverse_f64.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_mat_inverse_f64.c
 ...
 * same size.
 *
 * Matrix inversion is numerically sensitive and the CSI DSP library only supports matrix
 ...
 * <code>CSKY_MATH_SIZE_MISMATCH</code> if the input matrix is not square or if the size
 ...
 * <code>CSKY_MATH_SINGULAR</code>.  Otherwise, the function returns <code>CSKY_MATH_SUCCESS</code>.
 */

csky_status csky_mat_inverse_f64(
  const csky_matrix_instance_f64 * pSrc,
  csky_matrix_instance_f64 * pDst)
{
  ...
  csky_status status;                             /* status of matrix inverse */
