...
*
* This file comes from arm_mat_scale_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_mat_scale_f32.c
 * @brief    Multiplies a floating-point matrix by a scalar.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
