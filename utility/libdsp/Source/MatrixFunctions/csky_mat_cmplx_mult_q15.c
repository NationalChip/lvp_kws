...
* Title:        arm_mat_cmplx_mult_q15.c
...
*
* This file comes from arm_mat_cmplx_mult_q15.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_cmplx_mat_mult_q15.c
 ...
 *
 * \par
 * Refer to <code>csky_mat_mult_fast_q15()</code> for a faster but less precise version of this function.
 *
 */
  ...
  csky_matrix_instance_q15 * pDst)
{
...
#endif
  {
    ...
    do
    {
      ...
      do
      {
        ...
        *px++ = (q15_t) (__SSAT_16(sumReal >> 15));
        *px++ = (q15_t) (__SSAT_16(sumImag >> 15));
...

  {
    ...
    do
    {
      ...
      do
      {
        /* Set the variable sumReal and sumImag, that acts as accumulator, to zero */
        sumReal = 0;
        sumImag = 0;
