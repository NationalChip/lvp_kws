...
*
* This file comes from arm_std_q15.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_std_q15.c
 * @brief    Standard deviation of an array of Q15 type.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
  ...
  q15_t * pResult)
{
  ...
  csky_sqrt_q15(__SSAT_16((meanOfSquares - squareOfMean) >> 15), pResult);
