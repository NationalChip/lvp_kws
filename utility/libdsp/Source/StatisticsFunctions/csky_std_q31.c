...
* Title:        arm_std_q31.c
* Description:  Standard deviation of th elements of a Q31 vector
*
...
*
* This file comes from arm_std_q31.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_std_q31.c
 * @brief    Standard deviation of an array of Q31 type.
 * @version  V1.0
 * @date     20. Dec 2016
 ******************************************************************************/
  ...
  q31_t * pResult)
{
  ...
  csky_sqrt_q31((meanOfSquares - squareOfMean) >> 15, pResult);
