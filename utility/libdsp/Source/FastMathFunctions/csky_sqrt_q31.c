...
*
* This file comes from arm_sqrt_q31.c. It is renamed by replacing arm with csky.
* And, to impove th performace, the instructions of "fsqrt" is used, when a cpu
*
*/

/******************************************************************************
 * @file     csky_sqrt_q31.c
 ...
 * @return The function returns CSKY_MATH_SUCCESS if the input value is positive
 * and CSKY_MATH_ARGUMENT_ERROR if the input is negative.  For
 * negative inputs, the function returns *pOut = 0.
 *
 *\note
 * When the hard float instruction <code>fsqrts</code> is used, the accuracy will be lost from 3 LSB to 7 LSB.
 * So as the functions, who call this function.
 */
  ...
  q31_t * pOut)
{
  ...
  if(in > 0)
  {
      temp_float1 = (float)in / 2147483648;
