...
*
* This file comes from arm_cfft_radix4_f32.c. It is renamed by replacing arm
* with csky.
*
*/

/******************************************************************************
 * @file     csky_cfft_radix4_f32.c
...
void csky_radix4_butterfly_f32(
float32_t * pSrc,
uint16_t fftLen,
float32_t * pCoef,
...
void csky_radix4_butterfly_inverse_f32(
float32_t * pSrc,
uint16_t fftLen,
float32_t * pCoef,
uint16_t twidCoefModifier,
...
void csky_cfft_radix4_f32(
const csky_cfft_radix4_instance_f32 * S,
float32_t * pSrc)
{
   ...
   if(S->ifftFlag == 1u)
   {
      ...
      csky_radix4_butterfly_inverse_f32(pSrc, S->fftLen, S->pTwiddle,
      S->twidCoefModifier, S->onebyfftLen);
   }
   else
   {
      /*  Complex FFT radix-4  */
      csky_radix4_butterfly_f32(pSrc, S->fftLen, S->pTwiddle,
      S->twidCoefModifier);
   }
