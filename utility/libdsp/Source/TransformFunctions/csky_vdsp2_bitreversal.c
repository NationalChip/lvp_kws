...
*
* This file comes from arm_bitreversal.c. It is renamed by replacing arm with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_bitreversal.c
...
* @return none.
*/
void csky_vdsp2_bitreversal_32(uint32_t *pSrc, int bitRevLen, uint16_t *pBitRevTab)
{
	int i = 0;
	int j = (bitRevLen + 1) >> 1;
	uint32_t tmp1, tmp2;
...
void csky_vdsp2_bitreversal_16(uint32_t *pSrc, int bitRevLen, uint16_t *pBitRevTab)
{
	int i = 0;
	int j = (bitRevLen + 1) >> 1;
	uint32_t tmp1, tmp2;
...
void csky_vdsp2_bitreversal_f32(
float32_t * pSrc,
uint16_t fftSize,
