...
*
* This file comes from arm_rfft_fast_f32.c. It is renamed by replacing arm with csky_vdsp2.
*
*/

/******************************************************************************
 * @file     csky_vdsp2_rfft_f32.c
 ...
 * \par Floating-point
 * The main functions are <code>csky_vdsp2_rfft_fast_f32()</code>
 * and <code>csky_vdsp2_rfft_fast_init_f32()</code>.  The older functions
 * <code>csky_vdsp2_rfft_f32()</code> and <code>csky_vdsp2_rfft_init_f32()</code> have been
 ...
 * <pre>
 *csky_vdsp2_rfft_instance_q31 S = {fftLenReal, fftLenBy2, ifftFlagR, bitReverseFlagR, twidCoefRModifier, pTwiddleAReal, pCfft};
 *csky_vdsp2_rfft_instance_q15 S = {fftLenReal, fftLenBy2, ifftFlagR, bitReverseFlagR, twidCoefRModifier, pTwiddleAReal, pCfft};
 * </pre>
 ...
 * must also be initialized.  Refer to csky_vdsp2_cfft_radix4_f32() for details regarding
...
* @param[in]  *S              points to an csky_vdsp2_rfft_fast_instance_f32 structure.
...
* \code
* csky_vdsp2_rfft_fast_f32(&csky_vdsp2_rfft_sR_f32_len32, pSrc, pDst, ifftFlag);
* csky_vdsp2_rfft_fast_f32(&csky_vdsp2_rfft_sR_f32_len64, pSrc, pDst, ifftFlag);
* ....
* csky_vdsp2_rfft_fast_f32(&csky_vdsp2_rfft_sR_f32_len4096, pSrc, pDst, ifftFlag);
* csky_vdsp2_rfft_fast_f32(&csky_vdsp2_rfft_sR_f32_len8192, pSrc, pDst, ifftFlag);
* \endcode
*
*/
...
uint8_t ifftFlag)
{
   csky_vdsp2_cfft_instance_f32 * Sint = &(S->Sint);
   ...
   if(ifftFlag)
   {
      ...
      csky_vdsp2_cfft_f32( Sint, pOut, ifftFlag, 1);
   }
   else
   {
      /* Calculation of RFFT of input */
      csky_vdsp2_cfft_f32( Sint, p, ifftFlag, 1);
