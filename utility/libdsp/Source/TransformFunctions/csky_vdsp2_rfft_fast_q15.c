...
*
* This file comes from arm_rfft_q15.c. It is renamed by replacing arm with csky_vdsp2.
...
void csky_vdsp2_split_rfft_fast_q15(
    q15_t * pSrc,
    uint32_t fftLen,
    q15_t * pATable,
    q15_t * pBTable,
...
void csky_vdsp2_split_rifft_fast_q15(
    q15_t * pSrc,
    uint32_t fftLen,
    q15_t * pATable,
    q15_t * pBTable,
...
void csky_vdsp2_rfft_fast_q15(
    ...
    q15_t * pDst)
{
    const csky_vdsp2_cfft_instance_q15 *S_CFFT = S->pCfft;
    uint32_t i;
    ...
    if(S->ifftFlagR == 1u)
    {
        ...
        csky_vdsp2_split_rifft_fast_q15(pSrc, L2, S->pTwiddleAReal, S->pTwiddleBReal, pDst);

        /* Complex IFFT process */
        csky_vdsp2_cfft_fast_q15(S_CFFT, pDst, S->ifftFlagR, S->bitReverseFlagR);
    ...
    else
    {
        ...
        /* Complex FFT process */
        csky_vdsp2_cfft_fast_q15(S_CFFT, pSrc, S->ifftFlagR, S->bitReverseFlagR);

        /*  Real FFT core process */
        csky_vdsp2_split_rfft_fast_q15(pSrc, L2, S->pTwiddleAReal, S->pTwiddleBReal, pDst);
    }
}
