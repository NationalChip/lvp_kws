...
void csky_vdsp2_split_rfft_q15(
    q15_t * pSrc,
    uint32_t fftLen,
    q15_t * pATable,
    q15_t * pDst,
...
void csky_vdsp2_split_rifft_q15(
    q15_t * pSrc,
    uint32_t fftLen,
    q15_t * pATable,
    q15_t * pDst,
    ...
    q15_t * pDst)
{
    ...
    if(S->ifftFlagR == 1u)
    {
        ...
        csky_vdsp2_split_rifft_q15(pSrc, L2, S->pTwiddleAReal, pDst, S->twidCoefRModifier);

        /* Complex IFFT process */
        csky_vdsp2_cfft_q15(S_CFFT, pDst, S->ifftFlagR, S->bitReverseFlagR);
    ...
    else
    {
        ...
        /* Complex FFT process */
        csky_vdsp2_cfft_q15(S_CFFT, pSrc, S->ifftFlagR, S->bitReverseFlagR);

        /*  Real FFT core process */
        csky_vdsp2_split_rfft_q15(pSrc, L2, S->pTwiddleAReal, pDst, S->twidCoefRModifier);
    }
}
