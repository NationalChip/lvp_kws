...
void csky_vdsp2_split_rfft_q31(
    q31_t * pSrc,
    uint32_t fftLen,
    q31_t * pATable,
    q31_t * pDst,
...
void csky_vdsp2_split_rifft_q31(
    q31_t * pSrc,
    uint32_t fftLen,
    q31_t * pATable,
    q31_t * pDst,
    ...
    q31_t * pDst)
{
    ...
    if(S->ifftFlagR == 1u)
    {
        ...
        csky_vdsp2_split_rifft_q31(pSrc, L2, S->pTwiddleAReal, pDst, S->twidCoefRModifier);

        /* Complex IFFT process */
        csky_vdsp2_cfft_q31(S_CFFT, pDst, S->ifftFlagR, S->bitReverseFlagR);
    ...
    else
    {
        ...
        /* Complex FFT process */
        csky_vdsp2_cfft_q31(S_CFFT, pSrc, S->ifftFlagR, S->bitReverseFlagR);

        /*  Real FFT core process */
        csky_vdsp2_split_rfft_q31(pSrc, L2, S->pTwiddleAReal, pDst, S->twidCoefRModifier);
    }
}
