...
*
* This file comes from arm_cfft_f32.c. It is renamed by replacing arm with csky.
*
*/

/******************************************************************************
 * @file     csky_cfft_f32.c
...
extern void csky_radix8_butterfly_f32(
    float32_t * pSrc,
    uint16_t fftLen,
...
* tables are provided and defined in <code>csky_const_structs.h</code>.  Include
* this header in your function and then pass one of the constant structures as
* an argument to csky_cfft_f32.  For example:
* \par
* <code>csky_cfft_f32(csky_cfft_sR_f32_len64, pSrc, 1, 1)</code>
* \par
...
*   switch (length) {
*     case 16:
*       S = &csky_cfft_sR_f32_len16;
*       break;
*     case 32:
*       S = &csky_cfft_sR_f32_len32;
*       break;
*     case 64:
*       S = &csky_cfft_sR_f32_len64;
*       break;
*     case 128:
*       S = &csky_cfft_sR_f32_len128;
*       break;
*     case 256:
*       S = &csky_cfft_sR_f32_len256;
*       break;
*     case 512:
*       S = &csky_cfft_sR_f32_len512;
*       break;
*     case 1024:
*       S = &csky_cfft_sR_f32_len1024;
*       break;
*     case 2048:
*       S = &csky_cfft_sR_f32_len2048;
*       break;
*     case 4096:
*       S = &csky_cfft_sR_f32_len4096;
*       break;
*   }
* \endcode
* \par Q15 and Q31
...
* tables are provided and defined in <code>csky_const_structs.h</code>.  Include
* this header in your function and then pass one of the constant structures as
* an argument to csky_cfft_q31.  For example:
* \par
* <code>csky_cfft_q31(csky_cfft_sR_q31_len64, pSrc, 1, 1)</code>
* \par
* computes a 64-point inverse complex FFT including bit reversal.
* The data structures are treated as constant data and not modified during the
* calculation.  The same data structure can be reused for multiple transforms
...
*   switch (length) {
*     case 16:
*       S = &csky_cfft_sR_q31_len16;
*       break;
*     case 32:
*       S = &csky_cfft_sR_q31_len32;
*       break;
*     case 64:
*       S = &csky_cfft_sR_q31_len64;
*       break;
*     case 128:
*       S = &csky_cfft_sR_q31_len128;
*       break;
*     case 256:
*       S = &csky_cfft_sR_q31_len256;
*       break;
*     case 512:
*       S = &csky_cfft_sR_q31_len512;
*       break;
*     case 1024:
*       S = &csky_cfft_sR_q31_len1024;
*       break;
*     case 2048:
*       S = &csky_cfft_sR_q31_len2048;
*       break;
*     case 4096:
*       S = &csky_cfft_sR_q31_len4096;
*       break;
*   }
* \endcode
*
...
void csky_cfft_radix8by2_f32( csky_cfft_instance_f32 * S, float32_t * p1)
{
    uint32_t    L  = S->fftLen;
    ...
    // first col
    csky_radix8_butterfly_f32( pCol1, L, (float32_t *) S->pTwiddle, 2u);
    // second col
    csky_radix8_butterfly_f32( pCol2, L, (float32_t *) S->pTwiddle, 2u);
}

void csky_cfft_radix8by4_f32( csky_cfft_instance_f32 * S, float32_t * p1)
{
    ...
    *p4++ = m2 - m3;
    ...
    // first col
    csky_radix8_butterfly_f32( pCol1, L, (float32_t *) S->pTwiddle, 4u);
    // second col
    csky_radix8_butterfly_f32( pCol2, L, (float32_t *) S->pTwiddle, 4u);
    // third col
    csky_radix8_butterfly_f32( pCol3, L, (float32_t *) S->pTwiddle, 4u);
    // fourth col
    csky_radix8_butterfly_f32( pCol4, L, (float32_t *) S->pTwiddle, 4u);
}
    ...
    uint8_t bitReverseFlag)
{
    ...
    case 128:
    case 1024:
        csky_cfft_radix8by2_f32  ( (csky_cfft_instance_f32 *) S, p1);
        break;
    case 32:
    case 256:
    case 2048:
        csky_cfft_radix8by4_f32  ( (csky_cfft_instance_f32 *) S, p1);
        break;
    case 64:
    case 512:
    case 4096:
        csky_radix8_butterfly_f32( p1, L, (float32_t *) S->pTwiddle, 1);
        break;
    }

    if( bitReverseFlag )
        csky_bitreversal_32((uint32_t*)p1,S->bitRevLength,S->pBitRevTable);
