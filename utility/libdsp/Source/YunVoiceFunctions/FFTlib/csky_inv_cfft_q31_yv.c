...
/******************************************************************************
 * @file     csky_inv_cfft_q31_yv.c
 * @brief    Radix Decimation in Frequency Inverse CFFT fixed point processing function.
 * @version  V1.0
 * @date     15. Nov 2016
 ******************************************************************************/
#include "csky_math.h"
...
extern void csky_radix4_butterfly_inverse_yv_q31(
    q31_t * pSrc,
    uint32_t fftLen,
    const q31_t * pCoef,
...
void csky_cfft_radix4by2_inverse_yv_q31(
    q31_t * pSrc,
    uint32_t fftLen,
    const q31_t * pCoef);
...
/**
*
* @brief       Processing function for the Q31 complex inverse FFT.
    ...
    q31_t br)
{
    ...
    case 1024:
    case 4096:
        csky_radix4_butterfly_inverse_yv_q31(in_buf, L, twi_table, 1 );
        break;
    ...
    case 512:
    case 2048:
        csky_cfft_radix4by2_inverse_yv_q31(in_buf, L, twi_table );
        break;
    }
