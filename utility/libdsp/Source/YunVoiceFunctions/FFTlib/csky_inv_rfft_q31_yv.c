...
/******************************************************************************
 * @file     csky_inv_rfft_q31_yv.c
 * @brief    RIFFT Q31 process function.
 * @version  V1.0
 * @date     15. Nov  2017
 ******************************************************************************/
...
/**
*
* @brief       Processing function for the Q31 real inverse FFT.
    ...
    q31_t br)
{
    ...
    csky_split_rifft_yv_q31(in_buf, L, last_stage_twi_table, out_buf, 1);
    /* Complex IFFT process */
    csky_fft_lib_cx32_ifft(log2_buf_len, out_buf, out_buf, twi_table, 
                    bitrev_tbl, temp_buf, br);
